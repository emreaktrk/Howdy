...
import istanbul.codify.monju.api.pojo.request.GetWordsRequest;
import istanbul.codify.monju.api.pojo.request.GetWordsWithFilterRequest;
import istanbul.codify.monju.api.pojo.request.SuggestRequest;
import istanbul.codify.monju.api.pojo.response.ApiError;
import istanbul.codify.monju.api.pojo.response.GetWordsResponse;
import istanbul.codify.monju.api.pojo.response.GetWordsWithFilterResponse;
import istanbul.codify.monju.api.pojo.response.SuggestResponse;
...
final class WordPresenter extends BasePresenter<WordView> {
    ...
    public void attachView(WordView view, View root) {
        ...
        findViewById(R.id.word_search,AppCompatEditText.class).clearFocus();
