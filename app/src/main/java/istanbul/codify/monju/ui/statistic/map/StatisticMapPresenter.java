...
import istanbul.codify.monju.api.pojo.request.GetTopEmojisOnMapRequest;
import istanbul.codify.monju.api.pojo.response.ApiError;
import istanbul.codify.monju.api.pojo.response.GetTopEmojisOnMapResponse;
import istanbul.codify.monju.helper.rx.map.RxGoogleMap;
