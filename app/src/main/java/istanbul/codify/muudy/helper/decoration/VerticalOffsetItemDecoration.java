package istanbul.codify.muudy.helper.decoration;
 ...
 */
public final class VerticalOffsetItemDecoration extends RecyclerView.ItemDecoration {
     ...
     */
    public VerticalOffsetItemDecoration(int offsetPx) {
        mOffsetPx = offsetPx;
    }
